...
export function SidebarTrigger({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        'flex h-7 w-7 items-center justify-center rounded-md text-gray-500 hover:text-gray-800 hover:bg-gray-300 dark:text-gray-400 dark:hover:text-gray-100 dark:hover:bg-gray-700 transition-colors',
        className,
      )}
